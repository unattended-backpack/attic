...
gpg --verify atticd_${shaShort}_linux-amd64.tar.gz.asc atticd_${shaShort}_linux-amd64.tar.gz
gpg --verify atticadm_${shaShort}_linux-amd64.tar.gz.asc atticadm_${shaShort}_linux-amd64.tar.gz
\`\`\`
